...
enum OpenH264EncoderImplEvent {
    kH264EncoderEventInit = 0,
    kH264EncoderEventError = 1,
    kH264EncoderEventMax = 16,
};

unsigned short OpenH264EncoderImpl::NumberOfThreads(int width, int height, int number_of_cores) {
...
webrtc::FrameType OpenH264EncoderImpl::ConvertToVideoFrameType(EVideoFrameType type) {
    switch (type) {
...
// Helper method used by OpenH264EncoderImpl::Encode.
...
void OpenH264EncoderImpl::RtpFragmentize(webrtc::EncodedImage *encoded_image,
...
OpenH264EncoderImpl::OpenH264EncoderImpl(const cricket::VideoCodec &codec)
...
int32_t OpenH264EncoderImpl::InitEncode(const webrtc::VideoCodec *inst,
...
int32_t OpenH264EncoderImpl::Release() {
...
int32_t OpenH264EncoderImpl::RegisterEncodeCompleteCallback(
        webrtc::EncodedImageCallback *callback) {
    encoded_image_callback_ = callback;
    return WEBRTC_VIDEO_CODEC_OK;
}

int32_t OpenH264EncoderImpl::SetRateAllocation(
...
int32_t OpenH264EncoderImpl::Encode(const webrtc::VideoFrame &input_frame,
...
const char *OpenH264EncoderImpl::ImplementationName() const {
    return "OpenH264";
}
...
// in InitializeExt.
SEncParamExt OpenH264EncoderImpl::CreateEncoderParams(size_t i) {
...
void OpenH264EncoderImpl::ReportInit() {
    if (has_reported_init_)
        return;
    RTC_HISTOGRAM_ENUMERATION("WebRTC.Video.OpenH264EncoderImpl.Event",
                              kH264EncoderEventInit, kH264EncoderEventMax);
    has_reported_init_ = true;
}

void OpenH264EncoderImpl::ReportError() {
...
int32_t OpenH264EncoderImpl::SetChannelParameters(uint32_t packet_loss,
                                                  int64_t rtt) {
    return WEBRTC_VIDEO_CODEC_OK;
}

webrtc::VideoEncoder::ScalingSettings OpenH264EncoderImpl::GetScalingSettings() const {
